...
{
    /// <inheritdoc />
    public partial class UpdateAssessmentSystemConstraintsAndPrecision : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RubricCriteria_RubricId_SortOrder",
                table: "RubricCriteria",
                columns: new[] { "RubricId", "SortOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Questions_AssessmentId_SortOrder",
                table: "Questions",
                columns: new[] { "AssessmentId", "SortOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GradeBoundaries_GradingScaleId_SortOrder",
                table: "GradeBoundaries",
                columns: new[] { "GradingScaleId", "SortOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AnswerOptions_QuestionId_SortOrder",
                table: "AnswerOptions",
